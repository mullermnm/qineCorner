...
class SearchService {
  ...
  // Search books by title, author, or categories
  ...
  void handleSearch(String query) {
    ...
    for (final book in results) {
      debugPrint(
          '${book.title} by ${book.author} (${book.formattedPublishDate})');
  ...
  // Get popular books (sample implementation)
  ...
  // Get recent books (within last 5 years)
